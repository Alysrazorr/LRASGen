@echo off
REM ============================================================================
REM LRASGen — Run all 53 RESTful APIs through the full pipeline (Windows)
REM
REM Prerequisites:
REM   1. Set LRASGEN_DATASETS to the absolute path of the datasets directory:
REM        set LRASGEN_DATASETS=D:\Researches\LRASGen_RCR_working\assets\datasets
REM   2. Set LLM API keys:
...
REM
REM Usage:
REM   run_all_apis.bat
REM
REM Output lands in output\<api-name>\
REM ============================================================================
...
if "%LRASGEN_DATASETS%"=="" (
    ...
    echo   set LRASGEN_DATASETS=D:\Researches\LRASGen_RCR_working\assets\datasets
    exit /b 1
)

cd /d "%~dp0src"

REM ===== Spring Boot（Java） =====
